import i18next, { type i18n, type i18n as I18n, type InitOptions as I18nInitOptions } from "i18next";
import { initReactI18next } from "react-i18next";
import LanguageDetector from "i18next-browser-languagedetector";

const DEFAULT_I18N_OPTIONS: I18nInitOptions = {
  debug: true,
  fallbackLng: "en",
  supportedLngs: ["en", "th"],
  interpolation: {
...
const i18nService = {
  ...
  switchLanguage(): void {
    const targetLanguage = this.getCurrentLanguage() === "en" ? "th" : "en";
